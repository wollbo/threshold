...
where p is the proportion of positives in the underlying distribution and λ the ratio between the cost of a false positive contra that of a false negative. This threshold search framework may be applied to arbitrary settings associated with finding tradeoffs in binary classification, but has largely been developed for application in machine learning scenarios.
